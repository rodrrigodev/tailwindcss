  ...
  return (
    <div className="flex h-screen flex-col items-center bg-slate-50 p-8 text-center text-slate-900 dark:bg-slate-900 dark:text-slate-100">
      <div className="max-w-2xl">
        <h1 className="text-3l font-bold sm:text-4xl lg:text-5xl">
        ...
        <button className="mt-4 rounded-md bg-sky-500 px-4 py-2 font-medium text-white dark:bg-sky-400 dark:text-sky-950">
          Sign in
        </button>
      </div>
    </div>
